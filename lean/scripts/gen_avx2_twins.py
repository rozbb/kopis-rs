...
""",
     """  let* ⟨vec_s_ntt, hvecs_ntt⟩ ←
    from_secret_matrix_spec vec_s (secretSmall_of_bounded hvecbnd (by omega))
"""),
    ("PkeEncryptTop.lean",
     """  let* ⟨sprime_ntt, hspntt⟩ ← from_secret_matrix_spec vec_sprime
""",
     """  let* ⟨sprime_ntt, hspntt⟩ ←
    from_secret_matrix_spec vec_sprime (secretSmall_of_bounded hspbnd (by omega))
"""),
]
...
EXTRA_IMPORTS = {
    ...
    "NttMul.lean": ["Kopis.Avx2.Intrinsics"],
}
