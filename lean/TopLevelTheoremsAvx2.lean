...
theorem kopis512_keygen_then_encapsulate (seed randomness : Array U8 32#usize) :
    (do let ksk ← RustKopisAvx2.kem.KemSecretKey.expand_from_seed 2#usize 10#usize seed
        let kpk ← RustKopisAvx2.impls.kopis512.Kopis512SecretKey.public_key ksk
        RustKopisAvx2.impls.kopis512.Kopis512PublicKey.encapsulate_deterministic kpk randomness)
      ⦃ (ct : Array U8 736#usize) (ss : RustKopisAvx2.impls.SharedSecret) =>
...
theorem kopis768_keygen_then_encapsulate (seed randomness : Array U8 32#usize) :
    (do let ksk ← RustKopisAvx2.kem.KemSecretKey.expand_from_seed 3#usize 8#usize seed
        let kpk ← RustKopisAvx2.impls.kopis768.Kopis768SecretKey.public_key ksk
        RustKopisAvx2.impls.kopis768.Kopis768PublicKey.encapsulate_deterministic kpk randomness)
      ⦃ (ct : Array U8 1088#usize) (ss : RustKopisAvx2.impls.SharedSecret) =>
          -- the spec's encapsulation, with its two components named
...
theorem kopis1024_keygen_then_encapsulate (seed randomness : Array U8 32#usize) :
    (do let ksk ← RustKopisAvx2.kem.KemSecretKey.expand_from_seed 4#usize 6#usize seed
        let kpk ← RustKopisAvx2.impls.kopis1024.Kopis1024SecretKey.public_key ksk
        RustKopisAvx2.impls.kopis1024.Kopis1024PublicKey.encapsulate_deterministic kpk randomness)
      ⦃ (ct : Array U8 1472#usize) (ss : RustKopisAvx2.impls.SharedSecret) =>
          -- the spec's encapsulation, with its two components named
...
theorem kopis512_from_bytes_then_encapsulate (pk_bytes : Array U8 672#usize)
    ...
    (do let kpk ← RustKopisAvx2.impls.kopis512.Kopis512PublicKey.from_bytes pk_bytes
        RustKopisAvx2.impls.kopis512.Kopis512PublicKey.encapsulate_deterministic kpk randomness)
      ⦃ (ct : Array U8 736#usize) (ss : RustKopisAvx2.impls.SharedSecret) =>
          -- the spec's encapsulation, with its two components named
...
theorem kopis768_from_bytes_then_encapsulate (pk_bytes : Array U8 992#usize)
    (randomness : Array U8 32#usize) :
    (do let kpk ← RustKopisAvx2.impls.kopis768.Kopis768PublicKey.from_bytes pk_bytes
        RustKopisAvx2.impls.kopis768.Kopis768PublicKey.encapsulate_deterministic kpk randomness)
      ⦃ (ct : Array U8 1088#usize) (ss : RustKopisAvx2.impls.SharedSecret) =>
          -- the spec's encapsulation, with its two components named
...
theorem kopis1024_from_bytes_then_encapsulate (pk_bytes : Array U8 1312#usize)
    (randomness : Array U8 32#usize) :
    (do let kpk ← RustKopisAvx2.impls.kopis1024.Kopis1024PublicKey.from_bytes pk_bytes
        RustKopisAvx2.impls.kopis1024.Kopis1024PublicKey.encapsulate_deterministic kpk randomness)
      ⦃ (ct : Array U8 1472#usize) (ss : RustKopisAvx2.impls.SharedSecret) =>
          -- the spec's encapsulation, with its two components named
...
theorem kopis512_keygen_then_decapsulate (seed : Array U8 32#usize) (ek : Array U8 736#usize) :
    (do let ksk ← RustKopisAvx2.kem.KemSecretKey.expand_from_seed 2#usize 10#usize seed
        RustKopisAvx2.impls.kopis512.Kopis512SecretKey.decapsulate ksk ek)
      ⦃ (r : RustKopisAvx2.impls.SharedSecret) =>
...
theorem kopis768_keygen_then_decapsulate (seed : Array U8 32#usize) (ek : Array U8 1088#usize) :
    (do let ksk ← RustKopisAvx2.kem.KemSecretKey.expand_from_seed 3#usize 8#usize seed
        RustKopisAvx2.impls.kopis768.Kopis768SecretKey.decapsulate ksk ek)
      ⦃ (r : RustKopisAvx2.impls.SharedSecret) =>
          Properties.arrayToBytes r
...
theorem kopis1024_keygen_then_decapsulate (seed : Array U8 32#usize) (ek : Array U8 1472#usize) :
    (do let ksk ← RustKopisAvx2.kem.KemSecretKey.expand_from_seed 4#usize 6#usize seed
        RustKopisAvx2.impls.kopis1024.Kopis1024SecretKey.decapsulate ksk ek)
      ⦃ (r : RustKopisAvx2.impls.SharedSecret) =>
          Properties.arrayToBytes r
