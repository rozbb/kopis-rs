...
noncomputable def toBytes : (s : Size) →
    RustKopisAvx2.kem.KemPublicKey s.L → Result (Array U8 s.pkLen)
  | .k512 => RustKopisAvx2.impls.kopis512.KemPublicKey2.to_bytes
  | .k768 => RustKopisAvx2.impls.kopis768.KemPublicKey3.to_bytes
  | .k1024 => RustKopisAvx2.impls.kopis1024.KemPublicKey4.to_bytes
...
theorem keygen_then_to_bytes : ∀ (s : Size) (seed : Array U8 32#usize),
  ...
  | .k512, seed => Kopis.Avx2.Properties.kopis512_keygen_to_bytes_spec seed
