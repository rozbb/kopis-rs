-- AUTOGENERATED from Kopis/Properties/Serialize.lean by `make generated`.  Do not edit.
...
/-
  ...
  Useful extracted defs live in `ExtractedRustAvx2.lean`: `ser.deserialize_13`,
