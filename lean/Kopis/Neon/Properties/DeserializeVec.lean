-- AUTOGENERATED from Kopis/Properties/DeserializeVec.lean by `make generated`.  Do not edit.
...
theorem ringElem_deserialize_10_spec (bytes : Slice U8) (hlen : bytes.length = 32 * 10) :
  ...
  have hstream := Kopis.Neon.ringElem_deserialize_10_streamNat bytes hlen
    (fun arr harr => by
