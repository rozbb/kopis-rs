-- AUTOGENERATED from Kopis/Properties/GenMatrix.lean by `make generated`.  Do not edit.
...
/-
  ...
  Relates the Aeneas-extracted `RustKopisNeon.sample.gen_matrix_from_seed` to the audited
