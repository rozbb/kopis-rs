-- AUTOGENERATED from Kopis/Properties/NttBridge.lean by `make generated`.  Do not edit.
...
theorem ntt_entry_spec (N : ℕ) (sBound : ℤ)
  ...
  have hres1 : ∀ c, c < 256 → ((convZ u v N c : ℤ) : ZMod 7681)
  ...
  refine WP.spec_mono (show arithmetic.ntt.reduce_invntt_to_ring_elem acc
    ...
    · unfold arithmetic.ntt.reduce_invntt_to_ring_elem
      ...
      exact hr
    · refine WP.spec_mono (Kopis.Neon.reduce_invntt_to_ring_elem_neon N hN acc nu nv
      ...
      rw [← hr c hc, Int.emod_eq_of_lt h0 hb]) ?_
  · intro r hr
    apply Vector.ext
    intro n hn
    ...
    apply WP.spec_bind (show arithmetic.ntt.pointwise_mul_acc acc ne ne1
      ...
      · unfold arithmetic.ntt.pointwise_mul_acc
        ...
        exact pointwise_mul_acc_spec acc ne ne1 B B
          ...
          (by nlinarith)
      · refine WP.spec_mono (Kopis.Neon.pointwise_mul_acc_neon acc ne ne1 B B
