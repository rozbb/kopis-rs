...
`RustKopisNeon.core.num.{U8,U32}.count_ones` are different opaque constants from the serial
...
NEON sampler is proved against the same definition rather than a copy of it. -/
