/-
  # Kopis/Crt/Scheme.lean — why the two backends agree at the endpoints (plan phase F4).

  The vector NTT does not compute the same intermediate values as the portable one: it carries two
